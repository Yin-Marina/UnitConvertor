...
/**
 * <p>
 * This is the the Miles to Kilometers conversion behaviour class for CST8288-Object Oriented Programming with design patterns(Java) Lab 1.
 * </p>
 * <p>
 ...
 *
 */
public class MtoKMConverter implements UnitConverterInterface{
     ...
     * Miles to Kilometers.
     * @param unit1Amount The amount of Miles in double.
     * @return The equivalent of the Kilometers in double.
     */
    @Override
    ...
    /**
     * This method returns the amount in Miles in string for String representation.
     * @return The string representation of amount in Miles.
     */
    @Override
